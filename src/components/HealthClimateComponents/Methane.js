...
class MethaneComponent extends React.Component {
  state = {};
  render() {
      ...
      >
        ...
        <Grid container item xs={12} justify="center" alignItems="center">
          <Typography variant="body2" className={classes.bodyCopy}>
            ...
            rice, paddies and livestock production.This is followed by emissions
            from sewage and solid waste and oil and gas production.
          </Typography>
        </Grid>
        ...
        <Grid container item xs={12} justify="center" alignItems="center">
          <Typography variant="body2" className={classes.bodyCopy}>
            ...
            ground level ozone;chronic exposure to ozone is a factor of asthma
            and other chronic respiratory illness and can harm childhood lung
            development
          </Typography>
        </Grid>
